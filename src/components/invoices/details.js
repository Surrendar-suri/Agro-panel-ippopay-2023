...
function InvoiceDetails(props) {
        ...
        dispatch(invoiceDetails(params.id, (result) => {
            ...
            if (result) {
                ...
                setState({
                    ...
                    merchant_phone: data?.merchant?.phone?.national_number ?? "",
    ...
    const editPage = () => {
        history.push("/invoices/edit/" + params.id);
    }
                                                        ...
                                                        <tbody>
                                                            ...
                                                            {state.discount !== 0 ? (
                                                                ...
                                                                <tr>
                                                                    <td colSpan={4} className="txt-rig">
                                                                        {state.priceType == 'rs' ?
                                                                            <p className="table_value">Discount</p>
                                                                            :
                                                                            <p className="table_value">Discount ({state.rate} %)</p>
                                                                        }
                                                                    </td>
                                                                    <td>
                                        ...
                                        <Card className={state.invoiceType === "Farmer" ? "invoice_card_far" : "invoice_card"} style={{ marginTop: (state.create_gst === false && state.partial_payment === false ? "16px" : "20px") }}>
                                            ...
                                            <div className="send-invoice">
                                                ...
                                                <div className="invoice_card_3">
                                                    ...
                                                    <button className="creates_btn" style={{marginLeft:"15px"}} onClick={downloadPdf}>Download</button>
