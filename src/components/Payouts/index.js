...
import { toastError, toastSuccess, Toaster} from '../../helpers/Utils';
...
const Payouts = () => {
  ...
  /* const stateChanges=(payload) => {
                return { type: userConstants.QUICK_TRANSFER, payload }
            }*/
  useEffect(() => {
    getPayoutsList();
            ...
            <div className="container-fluid main-container p-0 ">
              <div className="business_top agro_card">
                ...
                <div className="business_header">
                  <h4 className="business_head">Payouts</h4>
                ...
                <div className="farmer_filter col-xs-12 m-b-30 p-0">
                    ...
                    <div className="payout_popup_search">
                      <div className="input-group">
                        <input
                          ...
                          type="text"
                          name={quick_transfer.search_type || "searchTerm"}
                          value={
                            quick_transfer[quick_transfer.search_type] ||
                            quick_transfer.searchTerm
                          }
                        ...
                        <div className="payout_popup_search_select">
                          <Select
                            ...
                            value={
                              quick_transfer.SearchType !== undefined &&
                              quick_transfer.SearchType
                            }
                            onChange={(e) => {
                  ...
                  <div className="col-xs-12 col-md-2 p-l-0">
                    <Select
                      ...
                      value={
                        quick_transfer.Status !== undefined && quick_transfer.Status
                      }
                    />
                  </div>
                  <div className="col-xs-12 col-md-2 p-0">
                    <Select
                      className="selectpicker"
                      options={pay_mode_filter}
                      placeholder="Select Mode"
                      onChange={(e) => selectFilter("selection", e)}
                      value={
                        quick_transfer.Selection !== undefined &&
                        quick_transfer.Selection
                      }
                    />
                  </div>
                  <div className="col-xs-12 col-md-2 p-r-0">
                    <Select
                      ...
                      options={type_filter}
                      placeholder="Contact"
                      onChange={(e) => selectFilter("content_type_filter", e)}
                      value={
                        quick_transfer.ContentTypeFilter !== undefined &&
                        quick_transfer.ContentTypeFilter
                      }
                    />
                  </div>
                </div>
                <div className="col-xs-12 p-0 m-b-30">
                  ...
                  <div className="col-xs-12 col-md-3 p-0">
                    <input
                      ...
                      onClick={() =>
                        dispatch(
                          stateChanges("QUICK_TRANSFER", {
                            open_picker: !quick_transfer.open_picker,
                          })
                        )
                      }
                      value={
                        quick_transfer.from !== ""
                          ? `${quick_transfer.from} ~ ${quick_transfer.to}`
                          : ""
                      }
                    />
                    {/* <div
                    className={
                      quick_transfer.open_picker
                  ...
                  {/* <div className="col-xs-12 col-md-2 p-r-0">
                                        <Select className="selectpicker" options={ Duration_Filter } onChange={ (e) => selectFilter("date_filter", e)} value={ quick_transfer.DateFilter !== undefined && quick_transfer.DateFilter }/> 
                                    </div> */}
                    ...
                    <div className="card-body">
                      <div className="table-responsive">
                        <table className="table agri_table ">
                          ...
                          <tbody>
                            {quick_transfer.payoutList.length > 0 ? (
                              quick_transfer.payoutList.map((list, i) => {
                                return (
                                  <tr key={i}>
                                    <td> {i + 1} </td>
                                    <td> {list.trans_id} </td>
                                    ...
                                    {/* <td> {list.merchant && list.merchant.name} </td> */}
                                    <td>
                                      {" "}
                                      {/* {list.internal &&
                                list.internal.Data &&
                                list.internal.Data
                                  .TransactionIdentification}{" "} */}
                                      {list.utr ? list.utr : "N/A"}
                                    </td>
                                    <td>
                                      {" "}
                                      <a
                                        onClick={() => openViewModal(list.trans_id)}
